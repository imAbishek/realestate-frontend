    ...
    <div className="min-h-screen bg-slate-50 py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 space-y-8 text-sm text-slate-600 leading-relaxed">
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">1. Information we collect</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">2. How we use your information</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">3. Sharing of information</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">4. Data retention</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">5. Cookies</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">6. Security</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">7. Contact</h2>

    ...
    <div className="min-h-screen bg-slate-50 py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 space-y-8 text-sm text-slate-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">2. Eligibility</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">3. Listings and content</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">4. Prohibited conduct</h2>
            <ul className="space-y-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">5. Account suspension</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">6. Disclaimer</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">7. Governing law</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-3">8. Changes to terms</h2>
          ...
          <div className="pt-4 border-t border-slate-100">
            <p className="text-slate-400">Questions? <Link href="/contact" className="text-brand-600 hover:underline">Contact us</Link>.</p>
          </div>
        </div>
      </div>
    </div>

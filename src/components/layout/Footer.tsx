    ...
    <footer className="bg-slate-900 text-slate-400 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-sm leading-relaxed">A trusted platform to buy, rent, and list verified properties — owners and buyers, no middlemen. Now in Coimbatore, expanding city by city.</p>
        </div>
        <div>
